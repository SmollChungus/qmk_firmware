...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[0] = LAYOUT(
		...
		KC_LSFT,          KC_Z,    KC_X, KC_C, KC_V, KC_B,  KC_N, KC_M,  KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, KC_UP,   KC_INS,     KC_P1,  KC_P2,   KC_P3,   KC_PENT,
		KC_LCTL, KC_LWIN, KC_LALT,                   KC_SPC,             KC_RALT, MO(1),   KC_RCTL, KC_LEFT, KC_DOWN, KC_RIGHT,   KC_P0,           KC_PDOT
	),
