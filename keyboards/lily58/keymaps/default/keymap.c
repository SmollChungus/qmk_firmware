 ...
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *                   | LAlt | LGUI |LOWER | /ENTER  /       \SPACE \  |RAISE |DELETE|PRTSCN| |
 *                   |      |      |      |/       /         \      \ |      |      |      |
 *                   `----------------------------'           '------''--------------------'
 */
 ...
 [_QWERTY] = LAYOUT(
  ...
  KC_LCTRL, KC_A,   KC_S,    KC_D,    KC_F,    KC_G,                       KC_H,    KC_J,    KC_K,    KC_L,    KC_P, KC_QUOT,
  KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B,     KC_MPLY, KC_MUTE, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,  KC_RSFT,
                      KC_LALT, KC_LGUI, LOWER, KC_ENT, KC_SPC,  RAISE,   KC_DEL, LSFT(LGUI(KC_S))
),
/* LOWER
 * ,-----------------------------------------.                    ,-----------------------------------------.
 * |      |      |      |      |      |      |                    |      |      |      |      |      |      |
...
[_LOWER] = LAYOUT(
  ...
  KC_GRV, KC_LEFT, KC_DOWN,   KC_RIGHT, KC_DLR,  KC_PERC,                   KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, KC_TILD,
...
bool oled_task_user(void) {
  if (is_keyboard_master()) {
    ...
    render_animation((timer_read() / 750) % 5);
  }
    return false;
}
#endif // OLED_ENABLE
